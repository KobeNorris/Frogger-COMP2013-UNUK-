...
public class ShortTruckController extends ObstacleController {
    private ShortTruckViewer viewer;
    ...
    public ShortTruckController(String type, int positionX, int positionY, double speed, double width, double height){
        ...
        if(type.equals("left")){
            this.viewer = new ShortTruckViewer(imageLinkLeft, positionX, positionY, width, height);
        }else if(type.equals("right")){
            this.viewer = new ShortTruckViewer(imageLinkRight, positionX, positionY, width, height);
        }
    }
    ...
    @Override
    public ShortTruckViewer getViewer(){
        return this.viewer;
    }
}
